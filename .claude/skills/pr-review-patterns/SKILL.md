...
- **Cross-team repo nudges → shared engineering operations channel.** Never DM individual maintainers for shared repos ([your-company]-devops, [your-company]-cli, [your-company]-deploy). Channel-level nudge respects team triage and avoids the DM-as-priority-injection pattern.
