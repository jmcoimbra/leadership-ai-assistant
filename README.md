...
> **Run `voice-capture` (step 4 below) before filling any templates.** The shipped voice profile is not yours. If you skip it and start drafting, the AI will write in someone else's voice and you will have to redo the work.
